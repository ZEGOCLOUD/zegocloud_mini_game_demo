...
public class QuickStartGameViewModel extends BaseGameViewModel {
    ...
    public static String getCode_url = "Your Get Code URL"; // Connect ZEGOCLOUD Technical support to get
    public static String SudMGP_APP_ID = "Your Game App ID";  // Connect ZEGOCLOUD Technical support to get

    // The appKey obtained from Sud platform application.
    public static String SudMGP_APP_KEY = "Your Game App Key"; // Connect ZEGOCLOUD Technical support to get
    ...
    protected void getCode(Activity activity, String userId, String appId, GameGetCodeListener listener) {
        ...
        Uri.Builder builder = Uri.parse(getCode_url).buildUpon();
